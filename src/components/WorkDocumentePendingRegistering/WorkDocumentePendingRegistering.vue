                ...
                <div class="q-pa-xs col-xs-12 col-sm-6 col-md-4">
                    <q-card>
                        <q-card-section style="display: flex;">
                            ...
                            <q-icon name="settings" class="cursor-pointer" style="color: orange; font-size: 1.5rem; margin-left: auto;" @click="openWorkOnDocument(props.row)" />
                        </q-card-section>
                        <q-separator />
            ...
            <template v-slot:body="props">
                <q-tr :props="props">
                    <q-td key="appid" :props="props">
                        <q-icon name="settings" class="cursor-pointer" style="color: orange; font-size: 1.5rem;" @click="openWorkOnDocument(props.row)" />
                    </q-td>
                    <q-td key="id_doc" :props="props">
                        {{ props.row.id_doc }}
                    </q-td>
                    <q-td key="track_creation_date" :props="props">
                        {{  displayDataDoc(props.row.track_creation_date) }}
                    </q-td>
...
<script lang="ts" src="./WorkDocumentePendingRegistering.ts" />
