...
<div class="q-pa-md" style="width: 100%;">
    ...
    <q-dialog v-model="viewDialogSelectDepartament" position="bottom">
        ...
        >
            ...
            <q-card-section>
                <ComboDepartamente :selectDepartament="selectDepartament" :selectDivizie="doNothing" title="Selectati departamentul initiator" />
            </q-card-section>
        </q-card>
    </q-dialog>
</div>
