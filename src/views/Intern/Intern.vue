...
<div class="q-pa-md" style="width: 100%;">
    ...
    <div class="row">
        <span class="col-2 form__label">Categorie destinatar</span>
    ...
    <div class="row">
        ...
        />
        <span class="col-4 form__label content__align--right" style="margin-left: 2px;">Cine depune documentul?</span>
        <q-input
                class="col-4"
                outlined
                style="max-height: 7vh;;"
                v-model="docApp.den_user_deponent"
                lazy-rules
                dense
                readonly
                no-parent-event
                ref="refDenUserDeponent"
                @click="inputUserDeponent"
                :input-style="{ fontFamily: 'Nunito Sans',fontWeight: 'bolder' }"
        >
        </q-input>
    </div>
        ...
        <div class="row">
            <span class="col-2 form__label">Departament initiator</span>
            <q-input
                    class="col-10"
                    outlined
                    style="max-height: 7vh;;"
                    v-model="docApp.den_org_initiator"
                    lazy-rules
                    dense
                    readonly
                    no-parent-event
                    ref="refOrgInitiator"
                    @click="inputOrgInitiator"
                    :input-style="{ fontFamily: 'Nunito Sans',fontWeight: 'bolder' }"
                    :rules="[ val => val && val.length > 0 || 'Completati departamentul initiator!']"
            >
            </q-input>
        </div>

        <div class="row">
            <span class="col-2 form__label">Departament destinatar</span>
            <q-input
                    class="col-10"
                    outlined
                    style="max-height: 7vh;;"
                    v-model="docApp.den_org_destinatar"
                    lazy-rules
                    dense
                    readonly
                    no-parent-event
                    ref="refOrgDestinatar"
                    @click="inputOrgDestinatar"
                    :input-style="{ fontFamily: 'Nunito Sans',fontWeight: 'bolder' }"
                    :rules="[ val => val && val.length > 0 || 'Completati departamentul destinatar!']"
            >
            </q-input>
        </div>
    ...
    <q-dialog v-model="viewDialogSelectUserDeponent" position="bottom">
        <q-card style="min-width: 70vw;"
                v-bind:class="{ 'partial80_height': $q.platform.is.mobile, 'partial60_height': $q.platform.is.desktop }"
        >
            <div style="display:flex;justify-content: flex-end;">
                <span class="material-icons cursor-pointer" @click="viewDialogSelectDepartamentInitiator=false" style="color:#747474;font-weight: bolder;font-size: 1.5em;">close</span>
            </div>

            <q-card-section>
                <ComboUser :SelectHandler="selectUserDeponent"  title="Selectati persoana care depune documentul" />
            </q-card-section>
        </q-card>
    </q-dialog>

    <q-dialog v-model="viewDialogSelectDepartamentInitiator" position="bottom">
        <q-card style="min-width: 70vw;"
                v-bind:class="{ 'partial80_height': $q.platform.is.mobile, 'partial60_height': $q.platform.is.desktop }"
        >
            <div style="display:flex;justify-content: flex-end;">
            ...
            <q-card-section>
                <ComboDepartamente :selectDepartament="selectDepartamentInitiator" :selectDivizie="doNothing" title="Selectati departamentul initator" />
            </q-card-section>
        </q-card>
    </q-dialog>

    <q-dialog v-model="viewDialogSelectDepartamentDestinatar" position="bottom">
        <q-card style="min-width: 70vw;"
                v-bind:class="{ 'partial80_height': $q.platform.is.mobile, 'partial60_height': $q.platform.is.desktop }"
        >
            <div style="display:flex;justify-content: flex-end;">
                <span class="material-icons cursor-pointer" @click="viewDialogSelectDepartamentDestinatar=false" style="color:#747474;font-weight: bolder;font-size: 1.5em;">close</span>
            </div>

            <q-card-section>
                <ComboDepartamente :selectDepartament="selectDepartamentDestinatar" :selectDivizie="doNothing" title="Selectati departamentul destinatar" />
            </q-card-section>
        </q-card>
    </q-dialog>
</div>
