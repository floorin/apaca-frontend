<template>
    <div style="margin-top: 10px;">
        ...
        <div style="display: flex;width:100%;justify-content: center;">
            <q-btn color="black" label="Descarca XLS!" size="sm" no-caps  :disable="ajaxSearchingDocs" :loading="ajaxSearchingDocs" @click="getXls" style="min-width: 170px;margin:2px;">
